...
async def _(event):
     if not event.text[0].isalpha() and event.text[0] not in ("/", "#", "@", "!"):
        ...
        await event.edit(
        f": •جميع اوامر سورس 𝐇𝐞𝐥𝐥𝐚𝐬

🚀 (`.م1`) ⟶ أوامر الأدمن /n
💬 (`.م2`) ⟶ أوامر المجموعة /n
✨ (`.م3`) ⟶ أوامر التفاعل /n
🛡️ (`.م4`) ⟶ أوامر الحماية /n
🚫 (`.م5`) ⟶ أوامر المنع /n
⚙️ (`.م6`) ⟶ أوامر التحكم /n/n
👑 (`.م7`) ⟶ أوامر الإشراف/n  
🔔 (`.م8`) ⟶ أوامر التنبيه /n 
📦 (`.م9`) ⟶ أوامر التخزين /n 
🛑 (`.م10`) ⟶ أوامر الوقاية/n  
✍️ (`.م11`) ⟶ أوامر الكتابة/n  
📚 (`.م12`) ⟶ أوامر المساعدة /n 
📤 (`.م13`) ⟶ **أوامر الإرسال /n
👀 (`.م14`) ⟶** أوامر المتابعة** /n
🎮 (`.م15`) ⟶** أوامر التسلية والمرح** /n 
📊 (`.م16`) ⟶** أوامر الإحصائيات** /n 
🖌️ (`.م17`) ⟶ **أوامر التمبلر والزخرفة **/n
🔢 (`.م18`) ⟶** أوامر الحسابات** /n 
🎁 (`.م19`) ⟶ **أوامر الميزات** /n
⭐ (`.م20`) ⟶ **أوامر التقييم** /n
🏆 (`.م21`) ⟶** أوامر تجميع النقاط**/n  
**ch:  @HELLASUserBot**︙ {F_O_1} **"
)
